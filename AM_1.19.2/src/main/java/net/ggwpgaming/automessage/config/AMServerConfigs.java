...
public class AMServerConfigs {
    ...
    public static final ForgeConfigSpec.ConfigValue<Boolean> SERVER_ONLY;

    static {
        BUILDER.push("[-----AutoMessage Configuration-----]");

        BUILDER.comment(" Configuration in this file is for *SERVER-SIDE* only (i.e. \"Thank you for joining our server!\" being sent only once to the client, and never again)");
        ...
        BUILDER.comment("# MAY NOT FUNCTION AS EXPECTED");
        SERVER_ONLY = BUILDER.comment().define("SERVER_ONLY", false);
